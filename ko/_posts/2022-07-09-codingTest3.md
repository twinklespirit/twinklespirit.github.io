...
* 네이밍 컨벤션(Naming Convention)
    ...
    * 각 단어를 밑줄(_)로 구분 *<span style=“color:gray”>- pythonic way~</span>*
...
> 더 알아보기
> snake case: ‘뱀 처럼 생긴 _’로 단어를 구분 (Python) <span style=“color:pink”>twinkle_little_star</span>
> camel case: ‘낙~타’ 대소문자로 단어를 구분 (Java) <span style=“color:pink”>twinkleLittleStar</span>
> pascal case: 첫 시작 문자**도** 대문자로 표현 <span style=“color:pink”>TwinkleLittleStar</span>
<br> 
...
> 예를 들어 임의의 조건으로 숫자 1억 개를 만들고 계산을 해야 한다면?
> 숫자 1억 개를 어디에 보관해야하죠….? 내 메모리…
> 제너레이터는 메모리 부담 없이 필요할 때마다 숫자를 만들어 줍니다! 
...
print("A1", "B2") # A1, B2 출력 # 2. sep 파라미터를 이용하여 구분자를 (,)로 지정할 수 있음
...
> 1. 변수명은 snake_case로 주석은 영어로 작성할 것
